        ...
        <div class="p-6 mx-auto w-full space-y-6">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-2">
                <div>
                    ...
                    <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">Update destination details, replace the cover image, or reset the form to the loaded values.</p>
                </div>
                <div class="flex flex-wrap gap-2">
                    <Link :href="route('admin.destinations.details', { id: props.destination.id })">
                        <Button variant="outline" size="sm" class="h-9 text-xs gap-1.5 bg-white dark:bg-zinc-950 dark:border-zinc-800">
                    ...
                    <div class="md:col-span-7 space-y-4">
                        <Card class="dark:border-zinc-800 shadow-sm">
                            <CardHeader class="p-4 pb-2">
                                ...
                                <CardDescription class="text-xs">Update the destination title, region, and marketing tag.</CardDescription>
                            </CardHeader>
                    ...
                    <div class="md:col-span-5 space-y-4">
                        <Card class="dark:border-zinc-800 shadow-sm overflow-hidden">
                            ...
                            <CardContent class="p-4 pt-2">
                                ...
                                <p v-if="removeImage" class="text-xs text-red-500 mt-2">Current image will be removed when you save.</p>
                            ...
                            <CardFooter class="bg-zinc-50/50 dark:bg-zinc-900/40 px-4 py-3 border-t dark:border-zinc-800 flex justify-end items-center gap-2">
                                <Button type="button" variant="outline" size="sm" class="h-9 text-xs gap-1.5" @click="resetForm">
