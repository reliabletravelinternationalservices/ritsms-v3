...
const submitForm = () => {
    form.post(route('admin.destinations.locations.store', { id: props.destination.id }), {
        preserveScroll: true,
        onSuccess: () => {
            clearSelectedImage();
        ...
        <div class="p-6 mx-auto w-full space-y-6">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-2">
                <div>
                    ...
                    <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">Register a localized attraction or
                        checkpoint under the main destination profile.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                    ...
                    <div class="md:col-span-5 space-y-4">
                        <Card class="dark:border-zinc-800 shadow-sm overflow-hidden">
                            ...
                            <CardFooter
                                class="bg-zinc-50/50 dark:bg-zinc-900/40 px-4 py-3 border-t dark:border-zinc-800 flex justify-end gap-2">
