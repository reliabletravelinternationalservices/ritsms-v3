...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div
                class="relative min-h-[100vh] flex-1 rounded-smr md:min-h-min p-6 rounded-xl border border-sidebar-border/70 dark:border-sidebar-border">
                <div class="flex flex-col space-y-6 max-w-4xl">
                    <HeadingSmall title="Creating a new package"
                        description="Create a package that can be added for your service" />
                    ...
                    <form @submit.prevent="submit" class="flex flex-col gap-2">
                        <div class="grid gap-6 md:grid-cols-2">
                            <div class="">
                                ...
                                <Input id="name" class="mt-1 block w-full" v-model="form.name" autocomplete="name"
                                    placeholder="e.g. Premium Boracay Package" />
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input id="duration" type="number" class="mt-1 block w-full" v-model="form.duration"
                                    autocomplete="duration" placeholder="How many days is your trip?" />
                                <div class="min-h-[1.5rem]">
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            <div class="grid gap-2">
                                ...
                                <CurrencyInput id="base_price" class="mt-1 block w-full" v-model="form.base_price"
                                    autocomplete="base_price" placeholder="0.00" />
                                <div class="min-h-[1.5rem]">
                            ...
                            <div class="grid gap-2">
                                ...
                                <CurrencyInput id="down_payment" class="mt-1 block w-full" v-model="form.down_payment"
                                    autocomplete="down_payment" placeholder="0.00" />
                                <div class="min-h-[1.5rem]">
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            <div class="grid gap-2">
                                ...
                                <Input id="destination" class="mt-1 block w-full" v-model="form.destination"
                                    autocomplete="destinations" placeholder="e.g. Boracay, Philippines" />
                                <div class="min-h-[1.5rem]">
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input id="season" type="text" class="mt-1 block w-full" v-model="form.season"
                                    autocomplete="season" placeholder="e.g. Winter" />
                                <div class="min-h-[1.5rem]">
                        ...
                        <div class="grid gap-2 md:grid-cols-2">
                            <div class="grid gap-2">
                                <Label for="selling_start_date">Selling Start Date <span
                                        class="text-[var(--muted-custom)]">(Optional)</span></Label>
                                <Input id="selling_start_date" type="date" class="mt-1 block w-full"
                                    v-model="form.selling_start_date" autocomplete="selling_start_date"
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input id="selling_end_date" type="date" class="mt-1 block w-full"
                                    v-model="form.selling_end_date" autocomplete="selling_end_date"
                                    placeholder="e.g. Group tour" />
                                <div class="min-h-[1.5rem]">
                        ...
                        <div class="grid gap-2 md:grid-cols-2">
                            <div class="grid gap-2">
                                ...
                                <Input id="tag" type="text" class="mt-1 block w-full" v-model="form.tag"
                                    autocomplete="tag" placeholder="e.g. Group tour" />
                                <div class="min-h-[1.5rem]">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Textarea id="description" rows="8" class="mt-1 block w-full" v-model="form.description"
                                autocomplete="description" placeholder="Tell us about this package?" />
                            <div class="min-h-[1.5rem]">
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            <div class="grid gap-2">
                                ...
                                <Textarea id="inclusions" rows="10" class="mt-1 block w-full" v-model="form.inclusions"
                                    autocomplete="inclusions" placeholder="What's included to this package?" />
                                <div class="min-h-[1.5rem]">
                            ...
                            <div class="grid gap-2">
                                ...
                                <Textarea id="exclusions" rows="10" class="mt-1 block w-full" v-model="form.exclusions"
                                    autocomplete="exclusions" placeholder="What's not included in this package?" />
                                <div class="min-h-[1.5rem]">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Textarea id="highlights" rows="10" class="mt-1 block w-full" v-model="form.highlights"
                                autocomplete="highlights" placeholder="What's different about this package?" />
                            <div class="min-h-[1.5rem]">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Textarea id="itineraries" rows="10" class="mt-1 block w-full" v-model="form.itineraries"
                                autocomplete="itineraries" placeholder="Any activities included in this package?" />
                            <div class="min-h-[1.5rem]">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Textarea id="notes" rows="4" class="mt-1 block w-full" v-model="form.notes"
                                autocomplete="notes"
                        ...
                        <div class="flex w-full justify-end">
                            ...
                            <Button type="submit" class="mt-4" :class="{ 'opacity-25': form.processing }"
