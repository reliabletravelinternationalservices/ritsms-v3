...
<template>
    <section class="flex flex-col items-center justify-center py-12 md:py-24 w-full bg-black/5 px-4 md:px-6">
        <div class="max-w-5xl w-full">
            <div class="w-full flex flex-col items-center gap-10 md:gap-14">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 w-full max-w-md sm:max-w-none">
                    
                    <a href="#" class="flex flex-col items-center justify-center p-6 md:p-8 shadow-md bg-[var(--primary-custom)] transition-all duration-300 hover:-translate-y-2 hover:shadow-xl group">
