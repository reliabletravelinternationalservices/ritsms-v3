...
<template>
    <section class="flex flex-col items-center justify-center py-16 md:py-24 w-full bg-black/5 px-4">
            ...
            <div class="w-full flex flex-col items-center gap-10 md:gap-14">
                ...
                <div class="flex flex-col items-center text-center space-y-4 max-w-3xl"> 
                    <div class="space-y-3">
                        ...
                        <p class="text-sm md:text-base font-roboto text-[var(--muted-custom)] max-w-xl mx-auto">
