...
<template>
    <section  class="relative flex overflow-hidden flex-col gap-4 items-center justify-center min-h-screen md:min-h-[700px] lg:min-h-[900px] py-12 px-4 md:px-6 bg-[var(--inbound-custom)]">
        <div class="max-w-5xl mx-auto relative z-10 flex flex-col gap-4 items-center justify-center">
        ...
        <span class="absolute top-40 left-2 -rotate-45 z-0 pointer-events-none opacity-10">
            <Icon icon="mdi:location" class="w-32 h-32 md:w-96 md:h-96 text-[var(--shadow-custom)]" />
        </span>

        <span class="absolute -bottom-60 -right-16 -rotate-45 z-0 pointer-events-none opacity-10">
