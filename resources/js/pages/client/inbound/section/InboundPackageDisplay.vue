    ...
    <div class="max-w-5xl mx-auto py-6 md:py-10 flex flex-col gap-6 md:gap-8">
      ...
      <div class="w-full flex flex-col gap-6">
        ...
        >
          ...
          <h3 class="font-bold uppercase text-xs md:text-sm tracking-[0.15em] text-[var(--primary-custom)]">
            No packages found
          </h3>
          <p class="font-roboto text-xs sm:text-sm md:text-base text-[var(--muted-custom)] max-w-md leading-relaxed">
            We couldn’t find any packages matching your selected filters. Clear a filter or try a broader search.
          </p>
        </div>
      </div>
