...
use App\Concerns\Package\EditPackageValidationRules;
...
{
    use EditPackageValidationRules;
    /**
     * Determine if the user is authorized to make this request.
     */
    public function authorize(): bool
    {
        return $this->isAllowedToEditPackage();
    }
    ...
    protected function failedAuthorization()
    {
        throw new HttpException(
            403,
            'You are not allowed to update packages.'
        );
    }
}
